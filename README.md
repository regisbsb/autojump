...
autojump - a faster way to navigate your filesystem [![Build Status](https://travis-ci.org/regisbsb/autojump.svg?branch=master)](https://travis-ci.org/regisbsb/autojump)
